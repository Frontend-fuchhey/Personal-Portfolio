...
export function ClockWidget() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-white font-roboto w-full z-[10]">
      <p className="text-[14px] font-normal opacity-90 mt-2 mb-0 tracking-wide">{dateString}</p>
      <h1 className="text-[64px] font-bold tracking-tight leading-none m-0 p-0">{timeString}</h1>
    </div>
  );
}
